...
class SlackKnowledgeExtractor:
    ...
    def _create_new_article(self, topic_singular: str, msg: SlackMessage, content_hash: str) -> Tuple[bool, str]:
    ...
    def _process_matched_message(self, keyword: str, msg: SlackMessage) -> Tuple[bool, str]:
        ...
        if existing_article:
            return self._append_to_existing_article(existing_article, msg, content_hash)
        else:
            return self._create_new_article(topic_singular, msg, content_hash)
    ...
    def run_extraction_workflow(self) -> bool:
        ...
        try:
            ...
            for msg in messages:
                ...
                success, action = self._process_matched_message(best_match, msg)
